...
public class LocatorPractice extends BaseTestUtils {

    @Test(invocationCount = 2)
    public void locators() {

        WebDriver driver = new ChromeDriver();
        driver.get(FrameWorkUtilities.getUrl("RSA_LocatorPractice"));
        ...
        staticWait(1);
        driver.findElement(XpathStore.SelectCheckBoxLocator("Remember ")).click();
        driver.findElement(XpathStore.SelectCheckBoxLocator("agree")).click();
